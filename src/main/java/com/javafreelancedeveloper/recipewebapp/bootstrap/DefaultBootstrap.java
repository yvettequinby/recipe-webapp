package com.javafreelancedeveloper.recipewebapp.bootstrap;
...
public class DefaultBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	...
	public DefaultBootstrap(RecipeRepository recipeRepository, CategoryRepository categoryRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
		super();
	...
	private void initData() {
		log.debug("Bootstrap (Default) intialising data!");
	...
	private List<Recipe> getRecipes() {
		...
		guacRecipe
				.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside of the avocado with a blunt knife and scoop out the flesh with a spoon"
						+ "\n"
		...
		guacNotes
				.setRecipeNotes("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\n"
		...
		tacoNotes
				.setRecipeNotes("We have a family motto and it is this: Everything goes better in a tortilla.\n"
